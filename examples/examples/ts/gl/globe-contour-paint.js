...
$.when(
  $.getScript('/vendor-cdn/d3-array@2.8.0/dist/d3-array.js'),
  $.getScript('/vendor-cdn/d3-contour@2.0.0/dist/d3-contour.js'),
  $.getScript('/vendor-cdn/d3-geo@2.0.1/dist/d3-geo.js'),
  $.getScript('/vendor-cdn/d3-timer@2.0.0/dist/d3-timer.js')
).done(function () {
